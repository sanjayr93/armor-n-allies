...
public class ComboBox
{
	                ...
	                GUIStyle buttonStyle, GUIStyle boxStyle, GUIStyle listStyle )
	{
		...
		if( isClickedComboButton )
		{
			// Rectangle for the list box.... rect.y - (listStyle.CalcHeight(listContent[0], 1.0f) * noOfItems) is used to push the list box up...
			Rect listRect = new Rect( rect.x, rect.y - (listStyle.CalcHeight(listContent[0], 1.0f) * noOfItems),
